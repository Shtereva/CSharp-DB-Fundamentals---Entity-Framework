        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyOwned = table.Column<decimal>(type: "decimal(18, 2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql(@"ALTER TABLE PaymentMethods 
                                   ADD CONSTRAINT CK_notIdentical 
                                   CHECK ((BankAccountId IS NULL AND  CreditCardId IS NOT NULL) OR
